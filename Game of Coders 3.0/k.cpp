// Problem: K. The Red Tomato
// Contest: Codeforces - Game of Coders 3.0
// URL: https://codeforces.com/gym/105262/problem/K
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
void ITcharDo()
{
     ll n,minn=1e18,maxx=-1e18; cin>>n;
     FOR(j,0,n)
     {
     	...
     	if(c!=-1)maxx=max(maxx,sum);
     }
     if(maxx>=minn)cout<<"False Hypothesis"<<el;
     else cout<<maxx<<el;
}
int main()
{
